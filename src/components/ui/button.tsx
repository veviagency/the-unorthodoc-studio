  ...
  "inline-flex min-h-11 items-center justify-center gap-2 whitespace-nowrap rounded-sm text-sm font-semibold cursor-pointer transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 disabled:cursor-not-allowed [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        editorial: "bg-clay text-clay-foreground hover:bg-clay/90 hover:-translate-y-0.5",
        inverse: "bg-background text-foreground hover:bg-background/90 hover:-translate-y-0.5",
      },
      size: {
